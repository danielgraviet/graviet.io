...
Password-gated site tools (\`/tools/roadmap\`, \`/tools/work-log\`, related \`/api/tools/*\` routes) use the shared tools password (\`SEO_TOOLS_PASSWORD\`), not Auth.md agent credentials.
